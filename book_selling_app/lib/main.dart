    ...
    return Scaffold(
      body: Container(
        child: ListView(
          ...
          children: <Widget>[CustomTitleBar(), HorizontalListView(), HotList()],
        ),
      ),
    );
  }
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Expanded(
            child: Text(
              "BooksApp",
              style: TextStyle(fontSize: 30, fontFamily: "lovelo"),
            ),
          )
        ],
      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(
            "Novel with a popular franchise",
            style: TextStyle(
